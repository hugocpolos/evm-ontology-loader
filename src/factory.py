class Factory:
    ...
    evmEthicalBehaviorMonitor = None
    evmNormViolation = None
    evmSocioTechnologyGovernance = None
    evmLiabilitySanction = None
    evmLegalResponsibilityAscription = None
    evmgovernance = None
    evmresponsibility = None
    evmAccountablePerson = None
    evmDistributedResponsibility = None
    evmEnumDataTypes = None
    evmEthicalResponsibilityAscription = None
    evmlegal = None
    ...
    nepTeam = None
    nepPlanAction = None
    nepEthicalPrinciple = None
    nepDerogation = None
    nepAgentPlan = None
    nepnorm = None
    nepEthicalDilemma = None
    nepEthicalTheory = None
    nepSituationPlanRepertoire = None
    nepTaskAssignment = None
    nepSocialCollection = None
    nepEnvironment = None
    nepAnswer = None
    nepQuery = None
    nepActionRationale = None
    nepDilemmaMitigationPrinciple = None
    nepnorm = None
    nepteam = None
    nepCommunity = None
    nepCompany = None
    nepConsequentialistNorm = None
    nepDeontologicalNorm = None
    nepDepartment = None
    nepEnumDataTypes = None
    nepExplanation = None
    nepObligation = None
    nepOrganization = None
    nepPermission = None
    nepProhibition = None
    nepVirtuousNorm = None
    nepautonomous = None
    nepdilemma = None
    nepethical = None
    nepethical = None

    tloAgentCommunication = None
    tloMethod = None
    tloAgent = None
    tloProcess = None
    tloPlan = None
    tloInformationArtifact = None
    tloRole = None
    tloEnumDataTypes = None
    tloContinuant = None
    tloSituation = None
    tloCollective = None
    tloPhysical = None
    ...
    tloevmObject = None
    tloProperty = None
    tloSpatioTemporalPlace = None
    tloEnvironmentalEvent = None
    tloAttribute = None
    tloManner = None
    tloOccurrent = None
    tloInteractionProcess = None
    tloSchema = None
    tloSocialInteractionProcess = None
